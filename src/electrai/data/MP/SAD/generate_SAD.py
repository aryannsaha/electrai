'''
Inspired by /data/QM9/pbe/tzvp200_atomh1e_smallerbox/scripts/scanner_22.py
'''
import argparse
...
parser.add_argument(
    '--label_dir',
    default="/scratch/gpfs/ROSENGROUP/common/mp/chgcars"
    )
parser.add_argument(
    '--map_dict',
    default="/data/MP/chgcar_map_functional_to_task_id.json",
    help='mapping from functional to task_ids'
    )
